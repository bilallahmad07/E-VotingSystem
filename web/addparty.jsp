                ...
                <div id="lw2" style="height: 700px">
                    ...
                    <div id="lw22" style="height: 700px">
                        <div id="lw22left" style="height: 700px">
                            <form action="saveparty.jsp" method="post">
                                <table id="table1" border="1" style="height: 250px">
                                    <th colspan="2">Enter the Details of Party</th>
                                    <tr>
                                        <td class="align">Name</td>
                                        <td class="align"><input name="name" required></td>
                                    </tr>
                                    <tr>
                                        <td class="align">Symbol</td>
                                        <td class="align"><input name="symbol" required></td>
                                    </tr>
