                ...
                <div id="lw2" style="height: 700px">
                    <div id="lw21">
                        ...
                        <table id="tble1" style="width: 95%; height: 590px; margin-top: 5px; background-color: #ffcccc; text-align: center;">
                            ...
                            <tr class="tr1"><td><a href="addvoter.jsp">Add Voter</a></td></tr>
                            <tr class="tr1"><td><a href="deletevoter.jsp">Delete Voter</a></td></tr>
                            <tr class="tr1"><td><a href="updatevoter.jsp">Update Voter</a></td></tr>
