                            ...
                            <div id="lw22left" style="height: 700px">
                                ...
                                <%
                                    try {
                                        ...
                                        s.executeUpdate("delete from officer where Adhar = '" + request.getParameter("adhar") + "'");
                                        out.println("<center><h2>Officer Deleted Successfully</h2></center>");
                                    } catch (Exception e) {
                                        out.println("Officer not deleted:" + e);
                                    }
