                        ...
                        <div id="lw22left">
                            ...
                            <%
                                if (request.getParameter("msg") != null) {
                                    out.println("<center><h4>Query deleted</h4></center>");
                                }
                            %>
                            <center><h3>Querys</h3></center>
                            <table id="table1" border="1">
                                <tr><th>ID</th><th>Adhar</th><th>Query</th><th>Action</th></tr>
                                        ...
                                        <%
                                            ...
                                            while (rs.next()) {
                                                ...
                                                int qid = rs.getInt(3);
                                        %>
                                <tr><td><%=qid%></td><td><%=adhar%></td><td><%=query%></td><td><a href="delquery.jsp?qid=<%=qid%>">Delete</a></td></tr>
                                <%
                                    }
                                %>
                            </table>
