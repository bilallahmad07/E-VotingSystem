<%    if (((session.getAttribute("adhar")) == null) || ((session.getAttribute("Biometric")) == null) || ((session.getAttribute("type")) != "officer1.jsp")) {
                ...
                <div id="lw2" style="height: 700px">
                    ...
                    <div id="lw22" style="height: 700px">
                        <div id="lw22left">
                            <br><br>
                            <center>
                                <span style="font-size: 35px">Welcome Officer</span>
                            </center>
