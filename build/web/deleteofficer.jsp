                ...
                <div id="lw2" style="height: 700px">
                    ...
                    <div id="lw22" style="height: 700px">
                        <div id="lw22left" style="height: 700px">
                            <br><br>
                            <form action="delofficer.jsp" method="post">
                                <table align="center" id="table1" border="1" style="height: 200px">
                                    <tr><th colspan="2">Delete the Officer</th></tr>
                                    <tr>
                                        <td>Enter the Adhar of the Officer to be deleted:</td>
                                        <td><input name="adhar" id="adhar" required></td>
                                    </tr>
                                    <tr><td><input type="submit" onclick="return chkadhar()"></td><td><input type="reset" onclick="return res()"</td></tr>
                                </table>
                            </form>
                        </div>
