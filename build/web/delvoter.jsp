                    ...
                    <div id="lw22" style="height: 700px">
                        <div id="lw22left" style="height: 700px">
                            ...
                            try{
                                ...
                                s.executeUpdate("delete from voter where Adhar = '"+request.getParameter("adh")+"'");
                                out.println("<center><h2>Voter Deleted Successfully</h2></center>");
                            }
                            catch(Exception e){
                                out.println("Voter not deleted:"+e);
                            }
