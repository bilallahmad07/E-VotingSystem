                ...
                <div id="lw2" style="height: 700px">
                    <div id="lw21">
                        ...
                        <table id="tble1" style="width: 95%; height: 590px; margin-top: 5px; background-color: #ffcccc; text-align: center;">
                            ...
                            <tr class="tr1"><td><a href="addcandidate.jsp">Add Candidate</a></td></tr>
                            <tr class="tr1"><td><a href="deletecandidate.jsp">Delete Candidate</a></td></tr>
                            <tr class="tr1"><td><a href="updatecandidate.jsp">Update Candidate</a></td></tr>
